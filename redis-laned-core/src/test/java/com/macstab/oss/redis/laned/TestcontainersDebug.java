...
/**
 * Debug utility to test Testcontainers Docker detection.
 * Run with: ./gradlew :redis-laned-core:test --tests TestcontainersDebug --no-daemon
 */
public class TestcontainersDebug {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("testcontainers.ryuk.disabled: " + System.getProperty("testcontainers.ryuk.disabled"));
        
        System.out.println("\n=== Available Provider Strategies ===");
        ServiceLoader.load(DockerClientProviderStrategy.class).forEach(strategy -> {
